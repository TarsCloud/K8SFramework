...
func validTServer(newTServer, oldTServer *tarsAppsV1beta2.TServer, listers *informer.Listers) error {
...
func validCreateTServer(listers *informer.Listers, view *k8sAdmissionV1.AdmissionReview) error {
	newTServer := &tarsAppsV1beta2.TServer{}
	_ = json.Unmarshal(view.Request.Object.Raw, newTServer)
	return validTServer(newTServer, nil, listers)
}

func validUpdateTServer(listers *informer.Listers, view *k8sAdmissionV1.AdmissionReview) error {
	newTServer := &tarsAppsV1beta2.TServer{}
	_ = json.Unmarshal(view.Request.Object.Raw, newTServer)

	oldTServer := &tarsAppsV1beta2.TServer{}
	_ = json.Unmarshal(view.Request.OldObject.Raw, oldTServer)

	return validTServer(newTServer, oldTServer, listers)
}

func validDeleteTServer(listers *informer.Listers, view *k8sAdmissionV1.AdmissionReview) error {
	return nil
}
