...
func prepareActiveTConfig(newTConfig *tarsV1beta3.TConfig, listers *lister.Listers) error {
	if !listers.TCSynced() {
...
func prepareDeleteTConfig(tconfig *tarsV1beta3.TConfig, listers *lister.Listers) error {
	if !listers.TCSynced() {
		return fmt.Errorf("tconfig infomer has not finished syncing")
	}
