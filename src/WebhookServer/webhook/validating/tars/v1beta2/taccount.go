...
func validTAccount(newTAccount *tarsV1beta2.TAccount, oldTAccount *tarsV1beta2.TAccount, listers *lister.Listers) error {
...
func init() {
	gvr := tarsV1beta2.SchemeGroupVersion.WithResource("taccounts")
