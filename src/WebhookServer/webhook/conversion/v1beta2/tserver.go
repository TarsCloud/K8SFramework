...
func conversionTars1b1To1b2(src *tarsAppsV1beta1.TServerTars) *tarsAppsV1beta2.TServerTars {
	if src == nil {
		return nil
	}
...
func conversionNormal1b1To1b2(src *tarsAppsV1beta1.TServerNormal) *tarsAppsV1beta2.TServerNormal {
	if src == nil {
		return nil
	}
...
func conversionMount1b1To1b2(src []tarsAppsV1beta1.TK8SMount) []tarsAppsV1beta2.TK8SMount {
	if src == nil {
		return nil
	}
...
func conversionHostPorts1b1To1b2(src []*tarsAppsV1beta1.TK8SHostPort) []*tarsAppsV1beta2.TK8SHostPort {
	if src == nil {
		return nil
	}
	bs, _ := json.Marshal(src)
...
func CvTServer1b1To1b2(s []runtime.RawExtension) []runtime.RawExtension {
	...
	for i := range s {
		...
		if src.Spec.Release != nil {
			dst.Spec.Release = &tarsAppsV1beta2.TServerRelease{
		...
		for ii := 0; ii < 1; ii++ {
			...
			if dst.Spec.Tars != nil && dst.Spec.Release != nil {
				...
				dst.Spec.Release.TServerReleaseNode = &tarsAppsV1beta2.TServerReleaseNode{
					Image:  image,
					Secret: secret,
				}
			}
...
func conversionTars1b2To1b1(src *tarsAppsV1beta2.TServerTars) *tarsAppsV1beta1.TServerTars {
	if src == nil {
		return nil
	}
...
func conversionNormal1b2To1b1(src *tarsAppsV1beta2.TServerNormal) *tarsAppsV1beta1.TServerNormal {
	if src == nil {
		return nil
	}
...
func conversionMount1b2To1b1(src []tarsAppsV1beta2.TK8SMount) []tarsAppsV1beta1.TK8SMount {
	if src == nil {
		return nil
	}
	bs, _ := json.Marshal(src)
...
func conversionHostPorts1b2To1b1(src []*tarsAppsV1beta2.TK8SHostPort) []*tarsAppsV1beta1.TK8SHostPort {
	if src == nil {
		return nil
	}
	bs, _ := json.Marshal(src)
