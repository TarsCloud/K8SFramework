...
void LogImp::logger(const string &app, const string &server, const string &file, const string &format, const vector<string> &buffer, tars::CurrentPtr current)
{
...
void LogImp::loggerbyInfo(const LogInfo & info,const vector<std::string> & buffer,tars::CurrentPtr current)
{
    string nodeName = current->getHostName() ;
    // if(nodeName.empty())
    // {
