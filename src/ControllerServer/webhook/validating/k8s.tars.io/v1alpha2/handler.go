...
func validUpdateTDeploy(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	newTDeploy := &crdV1alpha2.TDeploy{}
	_ = json.Unmarshal(view.Request.Object.Raw, newTDeploy)

	oldTDeploy := &crdV1alpha2.TDeploy{}
...
func validTServer(newTServer, oldTServer *crdV1alpha2.TServer, clients *meta.Clients, informer *meta.Informers) error {
...
func prepareDeleteTConfig(tconfig *crdV1alpha2.TConfig, clients *meta.Clients, informer *meta.Informers) error {
...
func validCreateTConfig(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	newTConfig := &crdV1alpha2.TConfig{}
...
func validUpdateTConfig(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	newTConfig := &crdV1alpha2.TConfig{}
	_ = json.Unmarshal(view.Request.Object.Raw, newTConfig)
	oldTConfig := &crdV1alpha2.TConfig{}
...
func validTTemplate(newTTemplate *crdV1alpha2.TTemplate, oldTTemplate *crdV1alpha2.TTemplate, clients *meta.Clients, informer *meta.Informers) error {
...
func validCreateTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	newTTemplate := &crdV1alpha2.TTemplate{}
...
func validUpdateTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	oldTTemplate := &crdV1alpha2.TTemplate{}
...
func validDeleteTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	ttemplate := &crdV1alpha2.TTemplate{}
...
func validTImage(newImage *crdV1alpha2.TImage, oldImage *crdV1alpha2.TImage, clients *meta.Clients, informer *meta.Informers) error {
	newTImageVersionMap := make(map[string]*crdV1alpha2.TImageRelease, len(newImage.Releases))
...
func validTTree(newTTree *crdV1alpha2.TTree, oldTTree *crdV1alpha2.TTree, clients *meta.Clients, informer *meta.Informers) error {
...
func validTAccount(newTAccount *crdV1alpha2.TAccount, oldTAccount *crdV1alpha2.TAccount, client *meta.Clients, informer *meta.Informers) error {
