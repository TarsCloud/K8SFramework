...
func validUpdateTDeploy(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	newTDeploy := &crdV1beta1.TDeploy{}
	_ = json.Unmarshal(view.Request.Object.Raw, newTDeploy)

	oldTDeploy := &crdV1beta1.TDeploy{}
...
func validTServer(newTServer, oldTServer *crdV1beta1.TServer, clients *meta.Clients, informer *meta.Informers) error {
...
func prepareActiveTConfig(newTConfig *crdV1beta1.TConfig, clients *meta.Clients, informer *meta.Informers) error {
...
func prepareDeleteTConfig(tconfig *crdV1beta1.TConfig, clients *meta.Clients, informer *meta.Informers) error {
...
func validTTemplate(newTTemplate *crdV1beta1.TTemplate, oldTTemplate *crdV1beta1.TTemplate, clients *meta.Clients, informer *meta.Informers) error {
...
func validCreateTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	newTTemplate := &crdV1beta1.TTemplate{}
...
func validUpdateTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	oldTTemplate := &crdV1beta1.TTemplate{}
...
func validDeleteTTemplate(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	ttemplate := &crdV1beta1.TTemplate{}
...
func validTImage(newImage *crdV1beta1.TImage, oldImage *crdV1beta1.TImage, clients *meta.Clients, informer *meta.Informers) error {
	newTImageVersionMap := make(map[string]*crdV1beta1.TImageRelease, len(newImage.Releases))
...
func validTTree(newTTree *crdV1beta1.TTree, oldTTree *crdV1beta1.TTree, clients *meta.Clients, informer *meta.Informers) error {
...
func validTAccount(newTAccount *crdV1beta1.TAccount, oldTAccount *crdV1beta1.TAccount, client *meta.Clients, informer *meta.Informers) error {
...
func validCreateTAccount(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	newTAccount := &crdV1beta1.TAccount{}
...
func validUpdateTAccount(clients *meta.Clients, informer *meta.Informers, view *k8sAdmissionV1.AdmissionReview) error {
	...
	oldTAccount := &crdV1beta1.TAccount{}
