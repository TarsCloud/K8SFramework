...
func (r *StatefulSetReconciler) syncStatefulset(tserver *crdV1alpha2.TServer, statefulSet *k8sAppsV1.StatefulSet, namespace, name string) reconclie.ReconcileResult {
