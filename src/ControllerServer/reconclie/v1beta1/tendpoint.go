...
func (r *TEndpointReconciler) EnqueueObj(resourceName string, resourceEvent k8sWatchV1.EventType, resourceObj interface{}) {
	...
	case *crdV1beta1.TServer:
		...
		r.workQueue.Add(key)
	case *crdV1beta1.TEndpoint:
		tendpoint := resourceObj.(*crdV1beta1.TEndpoint)
...
func (r *TEndpointReconciler) reconcile(key string) reconclie.ReconcileResult {
	...
	if err != nil {
		...
		err = r.clients.CrdClient.CrdV1beta1().TEndpoints(namespace).Delete(context.TODO(), name, k8sMetaV1.DeleteOptions{})
	...
	if err != nil {
		...
		tendpointInterface := r.clients.CrdClient.CrdV1beta1().TEndpoints(namespace)
...
func (r *TEndpointReconciler) buildPodStatus(pod *k8sCoreV1.Pod) *crdV1beta1.TEndpointPodStatus {
	podStatus := &crdV1beta1.TEndpointPodStatus{
		UID:               string(pod.UID),
		Name:              pod.Name,
...
func (r *TEndpointReconciler) updateStatus(tendpoint *crdV1beta1.TEndpoint) reconclie.ReconcileResult {
	...
	tendpointPodStatuses := make([]*crdV1beta1.TEndpointPodStatus, 0, len(pods))
	...
	_, err = r.clients.CrdClient.CrdV1beta1().TEndpoints(namespace).UpdateStatus(context.TODO(), tendpointCopy, k8sMetaV1.UpdateOptions{})
