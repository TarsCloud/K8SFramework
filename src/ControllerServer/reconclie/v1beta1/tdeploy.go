...
func (r *TDeployReconcile) EnqueueObj(resourceName string, resourceEvent k8sWatchV1.EventType, resourceObj interface{}) {
	...
	case *crdV1beta1.TDeploy:
		tdeploy := resourceObj.(*crdV1beta1.TDeploy)
...
func (r *TDeployReconcile) reconcile(key string) reconclie.ReconcileResult {
	...
	if _, err = r.clients.CrdClient.CrdV1beta1().TServers(namespace).Create(context.TODO(), newTServer, k8sMetaV1.CreateOptions{}); err != nil && !errors.IsAlreadyExists(err) {
	...
	if _, err = r.clients.CrdClient.CrdV1beta1().TDeploys(namespace).Update(context.TODO(), tdeployCopy, k8sMetaV1.UpdateOptions{}); err != nil {
