...
func equalTarsServants(l, r []*tarsCrdV1beta3.TServerServant) bool {
	if len(l) != len(r) {
		return false
	}
...
func equalTars(l, r *tarsCrdV1beta3.TServerTars) bool {
...
func equalTServerPorts(l, r []*tarsCrdV1beta3.TServerPort) bool {
...
func equalNormal(l, r *tarsCrdV1beta3.TServerNormal) bool {
	if l == nil {
		if r == nil {
			return true
		}
...
func equalK8SHostPorts(l, r []*tarsCrdV1beta3.TK8SHostPort) bool {
	if len(l) != len(r) {
		return false
	}
	for i := range l {
...
func EqualTServerAndTEndpoint(tserver *tarsCrdV1beta3.TServer, endpoint *tarsCrdV1beta3.TEndpoint) bool {
...
func EqualTServerAndService(tserver *tarsCrdV1beta3.TServer, service *k8sCoreV1.Service) bool {
...
func EqualTServerAndDaemonSet(tserver *tarsCrdV1beta3.TServer, daemonSet *k8sAppsV1.DaemonSet) bool {
	...
	if tserver.Spec.SubType == tarsCrdV1beta3.TARS && initContainer == nil {
		return false
	}

	if tserver.Spec.SubType == tarsCrdV1beta3.Normal && initContainer != nil {
		return false
	}
...
func EqualTServerAndStatefulSet(tserver *tarsCrdV1beta3.TServer, statefulSet *k8sAppsV1.StatefulSet) bool {
