...
// AppsV1beta1Client is used to interact with features provided by the k8s.tars.io group.
type AppsV1beta1Client struct {
	restClient rest.Interface
}

func (c *AppsV1beta1Client) TAccounts(namespace string) TAccountInterface {
	return newTAccounts(c, namespace)
}

func (c *AppsV1beta1Client) TConfigs(namespace string) TConfigInterface {
	return newTConfigs(c, namespace)
}

func (c *AppsV1beta1Client) TEndpoints(namespace string) TEndpointInterface {
	return newTEndpoints(c, namespace)
}

func (c *AppsV1beta1Client) TExitedRecords(namespace string) TExitedRecordInterface {
	return newTExitedRecords(c, namespace)
}

func (c *AppsV1beta1Client) TImages(namespace string) TImageInterface {
	return newTImages(c, namespace)
}

func (c *AppsV1beta1Client) TServers(namespace string) TServerInterface {
	return newTServers(c, namespace)
}

func (c *AppsV1beta1Client) TTemplates(namespace string) TTemplateInterface {
	return newTTemplates(c, namespace)
}

func (c *AppsV1beta1Client) TTrees(namespace string) TTreeInterface {
