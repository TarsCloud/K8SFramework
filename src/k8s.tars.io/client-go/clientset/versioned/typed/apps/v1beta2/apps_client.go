...
// AppsV1beta2Client is used to interact with features provided by the k8s.tars.io group.
type AppsV1beta2Client struct {
	restClient rest.Interface
}

func (c *AppsV1beta2Client) TAccounts(namespace string) TAccountInterface {
	return newTAccounts(c, namespace)
}

func (c *AppsV1beta2Client) TConfigs(namespace string) TConfigInterface {
	return newTConfigs(c, namespace)
}

func (c *AppsV1beta2Client) TEndpoints(namespace string) TEndpointInterface {
	return newTEndpoints(c, namespace)
}

func (c *AppsV1beta2Client) TExitedRecords(namespace string) TExitedRecordInterface {
	return newTExitedRecords(c, namespace)
}

func (c *AppsV1beta2Client) TFrameworkConfigs(namespace string) TFrameworkConfigInterface {
	return newTFrameworkConfigs(c, namespace)
}

func (c *AppsV1beta2Client) TImages(namespace string) TImageInterface {
	return newTImages(c, namespace)
}

func (c *AppsV1beta2Client) TServers(namespace string) TServerInterface {
	return newTServers(c, namespace)
}

func (c *AppsV1beta2Client) TTemplates(namespace string) TTemplateInterface {
	return newTTemplates(c, namespace)
}

func (c *AppsV1beta2Client) TTrees(namespace string) TTreeInterface {
