...
var taccountsResource = schema.GroupVersionResource{Group: "k8s.tars.io", Version: "v1beta3", Resource: "taccounts"}

var taccountsKind = schema.GroupVersionKind{Group: "k8s.tars.io", Version: "v1beta3", Kind: "TAccount"}
