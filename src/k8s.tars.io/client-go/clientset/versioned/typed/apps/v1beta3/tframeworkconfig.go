...
type TFrameworkConfigInterface interface {
	Create(ctx context.Context, tFrameworkConfig *v1beta3.TFrameworkConfig, opts v1.CreateOptions) (*v1beta3.TFrameworkConfig, error)
	Update(ctx context.Context, tFrameworkConfig *v1beta3.TFrameworkConfig, opts v1.UpdateOptions) (*v1beta3.TFrameworkConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta3.TFrameworkConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta3.TFrameworkConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.TFrameworkConfig, err error)
...
func newTFrameworkConfigs(c *AppsV1beta3Client, namespace string) *tFrameworkConfigs {
...
func (c *tFrameworkConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta3.TFrameworkConfig, err error) {
	result = &v1beta3.TFrameworkConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tFrameworkConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta3.TFrameworkConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta3.TFrameworkConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tframeworkconfigs").
...
func (c *tFrameworkConfigs) Create(ctx context.Context, tFrameworkConfig *v1beta3.TFrameworkConfig, opts v1.CreateOptions) (result *v1beta3.TFrameworkConfig, err error) {
	result = &v1beta3.TFrameworkConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tframeworkconfigs").
...
func (c *tFrameworkConfigs) Update(ctx context.Context, tFrameworkConfig *v1beta3.TFrameworkConfig, opts v1.UpdateOptions) (result *v1beta3.TFrameworkConfig, err error) {
	result = &v1beta3.TFrameworkConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tframeworkconfigs").
...
func (c *tFrameworkConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.TFrameworkConfig, err error) {
	result = &v1beta3.TFrameworkConfig{}
