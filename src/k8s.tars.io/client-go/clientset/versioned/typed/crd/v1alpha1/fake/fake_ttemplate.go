...
var ttemplatesResource = schema.GroupVersionResource{Group: "crd", Version: "v1alpha1", Resource: "ttemplates"}

var ttemplatesKind = schema.GroupVersionKind{Group: "crd", Version: "v1alpha1", Kind: "TTemplate"}

// Get takes name of the tTemplate, and returns the corresponding tTemplate object, and an error if there is any.
func (c *FakeTTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ttemplatesResource, c.ns, name), &v1alpha1.TTemplate{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TTemplate), err
}
...
func (c *FakeTTemplates) Create(ctx context.Context, tTemplate *v1alpha1.TTemplate, opts v1.CreateOptions) (result *v1alpha1.TTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ttemplatesResource, c.ns, tTemplate), &v1alpha1.TTemplate{})
...
func (c *FakeTTemplates) Update(ctx context.Context, tTemplate *v1alpha1.TTemplate, opts v1.UpdateOptions) (result *v1alpha1.TTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ttemplatesResource, c.ns, tTemplate), &v1alpha1.TTemplate{})
...
func (c *FakeTTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ttemplatesResource, c.ns, name), &v1alpha1.TTemplate{})
...
func (c *FakeTTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.TTemplateList{})
	return err
}

// Patch applies the patch and returns the patched tTemplate.
func (c *FakeTTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ttemplatesResource, c.ns, name, pt, data, subresources...), &v1alpha1.TTemplate{})
