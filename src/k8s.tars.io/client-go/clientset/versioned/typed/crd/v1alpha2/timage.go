...
type TImageInterface interface {
	Create(ctx context.Context, tImage *v1alpha2.TImage, opts v1.CreateOptions) (*v1alpha2.TImage, error)
	Update(ctx context.Context, tImage *v1alpha2.TImage, opts v1.UpdateOptions) (*v1alpha2.TImage, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.TImage, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.TImageList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.TImage, err error)
	TImageExpansion
}
...
func newTImages(c *CrdV1alpha2Client, namespace string) *tImages {
	return &tImages{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tImages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.TImage, err error) {
	result = &v1alpha2.TImage{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("timages").
		Name(name).
...
func (c *tImages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.TImageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.TImageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("timages").
...
func (c *tImages) Create(ctx context.Context, tImage *v1alpha2.TImage, opts v1.CreateOptions) (result *v1alpha2.TImage, err error) {
	result = &v1alpha2.TImage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("timages").
...
func (c *tImages) Update(ctx context.Context, tImage *v1alpha2.TImage, opts v1.UpdateOptions) (result *v1alpha2.TImage, err error) {
	result = &v1alpha2.TImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("timages").
...
func (c *tImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.TImage, err error) {
	result = &v1alpha2.TImage{}
