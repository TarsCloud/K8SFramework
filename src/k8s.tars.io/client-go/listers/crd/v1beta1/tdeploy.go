...
type TDeployLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.TDeploy, err error)
...
// List lists all TDeploys in the indexer.
func (s *tDeployLister) List(selector labels.Selector) (ret []*v1beta1.TDeploy, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.TDeploy))
	})
	return ret, err
}
...
type TDeployNamespaceLister interface {
	...
	Get(name string) (*v1beta1.TDeploy, error)
...
// List lists all TDeploys in the indexer for a given namespace.
func (s tDeployNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.TDeploy, err error) {
...
// Get retrieves the TDeploy from the indexer for a given namespace and name.
func (s tDeployNamespaceLister) Get(name string) (*v1beta1.TDeploy, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("tdeploy"), name)
	}
	return obj.(*v1beta1.TDeploy), nil
}
