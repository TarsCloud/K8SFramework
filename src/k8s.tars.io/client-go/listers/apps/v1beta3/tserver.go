...
// List lists all TServers in the indexer.
func (s *tServerLister) List(selector labels.Selector) (ret []*v1beta3.TServer, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta3.TServer))
	})
	return ret, err
}
...
// List lists all TServers in the indexer for a given namespace.
func (s tServerNamespaceLister) List(selector labels.Selector) (ret []*v1beta3.TServer, err error) {
...
// Get retrieves the TServer from the indexer for a given namespace and name.
func (s tServerNamespaceLister) Get(name string) (*v1beta3.TServer, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta3.Resource("tserver"), name)
	}
	return obj.(*v1beta3.TServer), nil
}
