	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1beta3().TEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta3().TEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1beta3.TEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1beta3.TEndpoint{}, f.defaultInformer)
}
