	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1beta3().TTrees(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta3().TTrees(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1beta3.TTree{},
		resyncPeriod,
...
func (f *tTreeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1beta3.TTree{}, f.defaultInformer)
}
