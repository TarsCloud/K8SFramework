	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().TTrees(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().TTrees(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1alpha2.TTree{},
		resyncPeriod,
...
func (f *tTreeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1alpha2.TTree{}, f.defaultInformer)
}

func (f *tTreeInformer) Lister() v1alpha2.TTreeLister {
	return v1alpha2.NewTTreeLister(f.Informer().GetIndexer())
}
