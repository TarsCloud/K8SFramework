	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().TDeploys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().TDeploys(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1alpha2.TDeploy{},
		resyncPeriod,
...
func (f *tDeployInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1alpha2.TDeploy{}, f.defaultInformer)
}

func (f *tDeployInformer) Lister() v1alpha2.TDeployLister {
	return v1alpha2.NewTDeployLister(f.Informer().GetIndexer())
}
