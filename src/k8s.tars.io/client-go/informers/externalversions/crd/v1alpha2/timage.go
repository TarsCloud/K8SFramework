	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().TImages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().TImages(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1alpha2.TImage{},
		resyncPeriod,
...
func (f *tImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1alpha2.TImage{}, f.defaultInformer)
}

func (f *tImageInformer) Lister() v1alpha2.TImageLister {
	return v1alpha2.NewTImageLister(f.Informer().GetIndexer())
}
