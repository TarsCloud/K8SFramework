...
import (
	v1beta1 "k8s.tars.io/client-go/informers/externalversions/apps/v1beta1"
	v1beta2 "k8s.tars.io/client-go/informers/externalversions/apps/v1beta2"
	v1beta3 "k8s.tars.io/client-go/informers/externalversions/apps/v1beta3"
