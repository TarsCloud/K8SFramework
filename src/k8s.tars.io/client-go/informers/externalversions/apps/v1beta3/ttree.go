	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta3().TTrees(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta3().TTrees(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1beta3.TTree{},
		resyncPeriod,
...
func (f *tTreeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta3.TTree{}, f.defaultInformer)
}

func (f *tTreeInformer) Lister() v1beta3.TTreeLister {
	return v1beta3.NewTTreeLister(f.Informer().GetIndexer())
}
