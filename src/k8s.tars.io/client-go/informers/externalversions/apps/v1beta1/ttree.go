	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().TTrees(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().TTrees(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1beta1.TTree{},
		resyncPeriod,
...
func (f *tTreeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.TTree{}, f.defaultInformer)
}

func (f *tTreeInformer) Lister() v1beta1.TTreeLister {
	return v1beta1.NewTTreeLister(f.Informer().GetIndexer())
}
