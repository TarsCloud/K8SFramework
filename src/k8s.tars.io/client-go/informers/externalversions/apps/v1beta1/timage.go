	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta1().TImages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta1().TImages(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1beta1.TImage{},
		resyncPeriod,
...
func (f *tImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta1.TImage{}, f.defaultInformer)
}

func (f *tImageInformer) Lister() v1beta1.TImageLister {
	return v1beta1.NewTImageLister(f.Informer().GetIndexer())
}
