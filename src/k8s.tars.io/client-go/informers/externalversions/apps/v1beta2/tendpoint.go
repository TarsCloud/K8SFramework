...
type TEndpointInformer interface {
	...
	Lister() v1beta2.TEndpointLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1beta2().TEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1beta2().TEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&appsv1beta2.TEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1beta2.TEndpoint{}, f.defaultInformer)
}

func (f *tEndpointInformer) Lister() v1beta2.TEndpointLister {
	return v1beta2.NewTEndpointLister(f.Informer().GetIndexer())
}
