	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TarsV1beta3().TTrees(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TarsV1beta3().TTrees(namespace).Watch(context.TODO(), options)
			},
		},
		&tarsv1beta3.TTree{},
		resyncPeriod,
...
func (f *tTreeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tarsv1beta3.TTree{}, f.defaultInformer)
}
