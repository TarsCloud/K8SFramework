	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TarsV1beta2().TImages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TarsV1beta2().TImages(namespace).Watch(context.TODO(), options)
			},
		},
		&tarsv1beta2.TImage{},
		resyncPeriod,
...
func (f *tImageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tarsv1beta2.TImage{}, f.defaultInformer)
}
