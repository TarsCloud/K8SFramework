	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TarsV1beta2().TEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TarsV1beta2().TEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&tarsv1beta2.TEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tarsv1beta2.TEndpoint{}, f.defaultInformer)
}
