...
var _ = ginkgo.Describe("test account", func() {
	...
	ginkgo.BeforeEach(func() {
		taccountLayout := &tarsCrdV1Beta1.TAccount{
			TypeMeta: k8sMetaV1.TypeMeta{},
			ObjectMeta: k8sMetaV1.ObjectMeta{
				Name:      ResourceName,
				Namespace: s.Namespace,
			},
			Spec: tarsCrdV1Beta1.TAccountSpec{
				Username: Username,
				Authentication: tarsCrdV1Beta1.TAccountAuthentication{
					Password:  &Password,
					Activated: true,
				},
				Authorization: []*tarsCrdV1Beta1.TAccountAuthorization{},
			},
		}
		var taccount *tarsCrdV1Beta1.TAccount
