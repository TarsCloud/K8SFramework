...
var _ = ginkgo.Describe("try create tars server with unexpected filed value", func() {
	...
	ginkgo.Context("tars.servant", func() {
		ginkgo.BeforeEach(func() {
			tsLayout.Spec.Tars.Servants = []*tarsV1Beta3.TServerServant{
				{
					Thread:     3,
					Connection: 1000,
					Capacity:   1000,
	...
	ginkgo.Context("tars.ports", func() {
		ginkgo.BeforeEach(func() {
			tsLayout.Spec.Tars.Ports = []*tarsV1Beta3.TServerPort{
				{
					IsTcp: true,
				},
				{
	...
	ginkgo.Context("k8s", func() {
		...
		ginkgo.It("hostPort.nameRef not exist", func() {
			tsLayout.Spec.K8S.HostPorts = []*tarsV1Beta3.TK8SHostPort{
				{
					NameRef: "xxxx",
					Port:    99,
				},
		...
		ginkgo.It("duplicate mounts name", func() {
			...
			tsLayout.Spec.K8S.Mounts = []tarsV1Beta3.TK8SMount{
				{
					Name: "m1",
