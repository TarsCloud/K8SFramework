...
var _ = ginkgo.Describe("test app level config", func() {
	...
	ginkgo.BeforeEach(func() {
		appConfig := &tarsTarsV1beta2.TConfig{
		...
		_, err := tarsRuntime.Clients.CrdClient.TarsV1beta2().TConfigs(s.Namespace).Create(context.TODO(), appConfig, k8sMetaV1.CreateOptions{})
