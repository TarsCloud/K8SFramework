...
var _ = ginkgo.Describe("test app level config", func() {
	...
	ginkgo.BeforeEach(func() {
		appConfig := &tarsAppsV1beta3.TConfig{
		...
		_, err := tarsRuntime.Clients.CrdClient.AppsV1beta3().TConfigs(s.Namespace).Create(context.TODO(), appConfig, k8sMetaV1.CreateOptions{})
